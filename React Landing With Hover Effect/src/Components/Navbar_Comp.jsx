  ...
  return (
    ...
    <div className='bg_img'>
        <nav className='flex justify-between md:hidden'>
            ...
            <ul className='flex flex-col text-center gap-4 shadow-xl p-6 ring-1 absolute top-14 left-0 right-0 font-[500] bg-white translate-y-[-150%] transition-all duration-700 z-20 ' style={{transform: menuopen && "translatey(0%)"}}>
