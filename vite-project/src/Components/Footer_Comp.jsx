...
export const Footer_Comp = () => {
  return (
    ...
    <div className='flex flex-col justify-center mx-auto md:mx-0 space-y-4 md:w-1/2 text-center md:text-start'>
      ...
      <ul className='flex space-x-3 text-xl justify-center md:justify-start md:text-start'>
        <li className='text-gray-500 hover:text-red-500 duration-150 '><a href="#"><i class="fa-brands fa-facebook"></i></a></li>
    ...
    <div className='md:w-1/2 my-2 border-t md:border-none text-center md:text-start'>
    ...
    <div className='md:w-1/2 my-2 border-t md:border-none text-center mb-4 md:text-start'>
